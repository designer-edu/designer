...
.. code-block:: python
    ...
    def create_key_box(letter: str, x: int, y: int) -> KeyBox:
        ...
        return {
            'box': rectangle('black', BOX_SIZE, BOX_SIZE, x, y, border=1),
            'text': text('black', letter, BOX_SIZE, x, y),
            'active': False
        }
    ...
    def create_world() -> World:
        ...
        return {
            'left': create_key_box('<', center_x - BOX_SIZE/2, center_y),
            'right': create_key_box('>', center_x + BOX_SIZE/2, center_y),
        }
