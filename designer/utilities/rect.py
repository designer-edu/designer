...
class Rect:
    ...
    >>> rect1 = designer.utilities.vector.Rect(10, 10, 64, 64)               # Method 1
    >>> rect2 = designer.utilities.vector.Rect((10, 10), (64, 64))           # Method 2
    >>> rect3 = designer.utilities.vector.Rect(rect1.topleft, rect1.size)    # Method 2
    >>> rect4 = designer.utilities.vector.Rect(rect3)                        # Method 3
    ...
    def __getattr__(self, name):
        v = designer.utilities.vector.Vec2D
        if name == "right":
    ...
    def __setattr__(self, name, val):
        ...
        if name == "right":
            ...
            raise AttributeError(f"The attribute {name} was not recognized.")

    def copy(self):
        """
        Returns a copy of this rect

        :returns: A new :class:`Rect <designer.utilities.vector.Rect>`
        """
    ...
    def union(self, other):
        ...
        :type other: :class:`Rect <designer.utilities.vector.Rect>`
        :returns: A new :class:`Rect <designer.utilities.vector.Rect>`
        """
